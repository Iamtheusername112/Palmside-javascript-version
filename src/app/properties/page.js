...
import { Search, MapPin, Building2, Home, Filter } from 'lucide-react'
      ...
      <section className="bg-gradient-to-br from-blue-50 to-purple-50 py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            From cozy apartments to luxury homes, we have something for everyone.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <select className="flex h-9 rounded-md border border-input bg-background px-3 py-1 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
      ...
      <section className="py-16 bg-primary">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Let us know your requirements and we'll help you find the perfect property or notify you when something becomes available.
          </p>
